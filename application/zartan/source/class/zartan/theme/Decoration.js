...
qx.Theme.define("zartan.theme.Decoration",
{
  ...
  decorations :
  {
    ...
    "groupbox-open" :
    {
      style :
      {
        backgroundImage: "zartan/baseline-expand_less-24px.svg",
        backgroundRepeat: "no-repeat",
        backgroundPositionX: "right",
        backgroundPositionY: "center"
      }
    ...
    "groupbox-closed" :
    {
      style :
      {
        backgroundImage: "zartan/baseline-expand_more-24px.svg",
        backgroundRepeat: "no-repeat",
        backgroundPositionX: "right",
        backgroundPositionY: "center"
      }
    ...
    "page-button-right" :
    {
      style :
      {
        backgroundImage: "zartan/chevron_right-24px.svg",
        backgroundRepeat: "no-repeat",
        backgroundPositionX: "right",
        backgroundPositionY: "center"
      }
