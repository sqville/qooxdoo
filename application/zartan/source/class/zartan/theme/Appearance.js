...
qx.Theme.define("zartan.theme.Appearance",
{
  ...
  appearances :
  {
   ...
   "mainmenubutton/icon" : {
    ...
    /*
    ---------------------------------------------------------------------------
      zartan.MENUBUTTON - "hym" = hybrid moble (i.e. phonegap or cordova)
    ---------------------------------------------------------------------------
    */
    ...
    */
     ...
     "wax-window/close-button" :
    {
      ...
      style : function(states)
      {
        return {
          marginLeft : 2,
          icon : states.hovered ? "zartan/close-red-24px.svg" : "zartan/close-24px.svg",
          padding : [ 1, 2 ],
          cursor : states.disabled ? undefined : "pointer"
        };
      }
